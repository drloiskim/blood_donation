...
strategy.b<-c(current=1, optimal=0, atrisk=0, indemand=0, atrisk.thresh=0.9, indemand.thresh=0.7, lowhbdef.recall=12, vlowhbdef.recall=52, othdef.recall=4, prob.thresh=0.9, min.recall=12, curr.recall=12, length=52, thresh=13.5, hb.min=8.6, hb.max=21.1) # hb.min/max from BLUPS file
