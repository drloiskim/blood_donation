...
params=list("hb"=c(visit.coef=-0.4092, rettime.coef=0.0038, age1.coef=-0.0396, age2.coef=-0.1823, age3.coef=-0.2209, age4.coef=-0.3627, age5.coef=-0.4945, eth.coef=-0.3791, blood2.coef=0.0278, blood3.coef=0.1211, blood4.coef=0.1500, blood5.coef=0.0815, blood6.coef=0.1277, blood7.coef=0.0946, blood8.coef=0.0866, cons=15.2794), ## hb recovery
            ...
            "strategy"=c(current=0, optimal=1, atrisk=0, indemand=0, atrisk.thresh=0.9, indemand.thresh=0.7, lowhbdef.recall=12, vlowhbdef.recall=52, othdef.recall=4, prob.thresh=0.7, min.recall=12, curr.recall=12, length=52, thresh=13.5, hb.min=8.6, hb.max=21.1) # hb.min/max from BLUPS file
)
...
if(psa){
  ...
  if(overwrite)
    save.dta13(psa.hb$psasummary,("./men/output/men_medcert_psa.dta"))
}
