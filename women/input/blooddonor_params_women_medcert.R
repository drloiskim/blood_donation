...
strategy.b<-c(current=0, optimal=1, atrisk=0, indemand=0, atrisk.thresh=0.9, indemand.thresh=0.7, lowhbdef.recall=12, vlowhbdef.recall=52, othdef.recall=4, prob.thresh=0.7, min.recall=16, curr.recall=16, length=52, thresh=12.5, hb.min=8.7, hb.max=20.8) # indicators for recall strategy type
