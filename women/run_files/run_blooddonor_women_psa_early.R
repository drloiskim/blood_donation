...
psa<-"TRUE"
source("./women/input/blooddonor_params_women_early.R")
...
## HIGH CERTAINTY WITH EARLY RECALL
...
params=list("hb"=c(visit.coef=-0.5723, rettime.coef=0.0118, age1.coef=0.0674, age2.coef=-0.0546, age3.coef=0.1116, age4.coef=0.1888, age5.coef=0.1733, eth.coef=-0.4193, blood2.coef=0.0098, blood3.coef=0.0963, blood4.coef=0.0879, blood5.coef=0.0776, blood6.coef=0.0182, blood7.coef=0.0732, blood8.coef=0.2769, cons=13.3709), ## hb recovery
            ...
            "strategy"=c(current=0, optimal=1, atrisk=0, indemand=0, atrisk.thresh=0.9, indemand.thresh=0.7, lowhbdef.recall=12, vlowhbdef.recall=52, othdef.recall=4, prob.thresh=0.7, min.recall=12, curr.recall=16, length=52, thresh=12.5, hb.min=8.7, hb.max=20.8) # indicators for recall strategy type
)
...
if(psa){
  ...
  if(overwrite)
  save.dta13(psa.hb$psasummary,("./women/output/women_early_psa.dta"))
}
