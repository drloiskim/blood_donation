...
# NOTE: recall=recall.thresh for all models other than current (model 1) 
model.hb<-des(N=10000, params=params, agedist=agedist, exagedist=exagedist, hbdist=hbdist, ethdist=ethdist, blooddist=blooddist, prevdefdist=prevdefdist, prevdondist=prevdondist, blupdist=blupdist, blupsedist=blupsedist, recall=recall.thresh, attend=attend.dist,
...
if(overwrite)
  save.dta13(model.hb$eventhistory,("./women/output/women_medcert.dta"))
